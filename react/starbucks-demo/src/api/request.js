...
// export const getMenuListRequest = ({tab}) => 
...
export const getMenuListRequest = () => {
    return axios.get('https://www.fastmock.site/mock/5321bf649d06645c4266f3e0d45ae1cc/menu/all')
}

export const getHotListRequest = () =>{
    return axios.get('https://www.fastmock.site/mock/5321bf649d06645c4266f3e0d45ae1cc/menu/hot')
}